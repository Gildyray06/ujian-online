		...
		<div class="col-md-12">
			...
			<div class="box box-success" style="overflow-x: scroll;">
				<div class="box-header">
					...
					<center>
						<div class="box-title">Tambah Soal Ujian</div>
					</center>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control" id="taxonomy_level" required name="taxonomy_level">
										...
										<option value="2">Pemahaman</option>
										<option value="3">Penerapan</option>
										<option value="4">Analisis</option>
										<option value="5">Evaluasi</option>
										<option value="6">Membuat</option>
									</select>
								</div>
							</div>
